...
export interface GuardedInputOptions {
  ...
  isActive?: boolean;
  /**
   * Called for each recognised mouse event parsed out of a swallowed input
   ...
   * future delivery change. App.tsx uses this for tree dispatch, while
   * MouseClickable instances use it for component-local hover and click
   * hit-testing. Consumers without mouse behavior omit it and only swallow.
   */
